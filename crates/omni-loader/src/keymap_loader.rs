...
const DEFAULT_BINDINGS: &[(&str, &str)] = &[
    ...
    // Tab by index (Ctrl+1 through Ctrl+9)
    ("ctrl+1", "switch_tab_1"),
    ("ctrl+2", "switch_tab_2"),
    ("ctrl+3", "switch_tab_3"),
    ("ctrl+4", "switch_tab_4"),
...
pub fn resolve_action(name: &str) -> Option<Action> {
    match name {
        ...
        "switch_tab_1" => Some(Action::SwitchTab(0)),
        "switch_tab_2" => Some(Action::SwitchTab(1)),
        "switch_tab_3" => Some(Action::SwitchTab(2)),
        "switch_tab_4" => Some(Action::SwitchTab(3)),
        "switch_tab_5" => Some(Action::SwitchTab(4)),
        "switch_tab_6" => Some(Action::SwitchTab(5)),
        "switch_tab_7" => Some(Action::SwitchTab(6)),
        "switch_tab_8" => Some(Action::SwitchTab(7)),
        "switch_tab_9" => Some(Action::SwitchTab(8)),
